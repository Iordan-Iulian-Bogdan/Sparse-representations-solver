...
Features :
  ...
  - supports 32bit and 64bit floating point formats (64bit FP GPU acceleration may be worse due to the fact that a lot of GPU have lower double precision throughput)
